    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                ...
                <form class="w-full px-10" method="POST" action="{{ route('challenges.store') }}" enctype="multipart/form-data">
                    @csrf
                    <h2 class="text-2xl text-center font-bold ml-10 mb-10">Add Challenge</h2>
                    <div class="relative z-0 w-full mb-8 group">
                        <input type="text" name="title" id="title" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('title') border-red-500 @enderror" placeholder=" " value="{{ old('title') }}" />
                        @error('title')
                            <div class="text-red-500 bg-red-900">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="relative z-0 w-full mb-8 group">
                        ...
                        @error('image')
                            <div class="text-red-300 bg-red-900">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="relative z-0 w-full mb-8 group">
                        <select name="level" id="level" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required >
                            <option value="Low">Low</option>
                            <option value="Medium">Medium</option>
                            <option value="High">High</option>
                            <option value="Uper-high">Super-high</option>
                        </select>
                    ...
                    <div class="relative z-0 w-full mb-8 group">
                        <textarea type="text" name="description" id="description" class="block py-4 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required ></textarea>
